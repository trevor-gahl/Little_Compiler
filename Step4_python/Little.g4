...
func_decl
    : 'FUNCTION' any_type im '('param_decl_list')' 'BEGIN' func_body 'END'
    ;
...
CAPS is a token (terminal) made up of one or more characters. small case symbols are non-terminals.*/
