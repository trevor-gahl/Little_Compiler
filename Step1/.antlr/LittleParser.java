...
public class LittleParser extends Parser {
	...
	public static class FirstparserContext extends ParserRuleContext {
		public FirstparserContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_firstparser; }
	}

	public final FirstparserContext firstparser() throws RecognitionException {
		FirstparserContext _localctx = new FirstparserContext(_ctx, getState());
		enterRule(_localctx, 0, RULE_firstparser);
		try {
