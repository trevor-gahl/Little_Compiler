...
class LittleListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by LittleParser#pgm_bdy.
    def enterPgm_bdy(self, ctx:LittleParser.Pgm_bdyContext):
        pass

    # Exit a parse tree produced by LittleParser#pgm_bdy.
    def exitPgm_bdy(self, ctx:LittleParser.Pgm_bdyContext):
        pass
